...
patternpicx=r\'(010[aA][cC]480[cC]391[cC]391[cC]391(?!.*010[aA][cC]480[cC]391[cC]391[cC]391))(.*?)(01[cC]88[aA])(.{28})(.{8})(.{26})(.{10})(.{36})(03)(.{8})(.{8})(.{8})(.{8})(.*?)\'
...
def appendnewpic(w,h,picname,newdir1,objno2,columntype):
            ...
            with open(curnotefpc, \'rb\') as f:
                ...
                if regexc1.search(cihx):
                    ...
                    if "nextcolumn" in columntype:
                        ...
                        posxpresuffixint=int(prevxcoordinate[0:2],16)
                        posxsuffixint=int(prevxcoordinate[2:4],16)
                        posxint=int(prevxcoordinate[4:6],16)
                        posxremint=int(prevxcoordinate[6:],16)
                    ...
                    if "sameline" in columntype:
                        ...
                        print(prevycoordinate)
                    elif "nextline" in columntype or "slidenextline" in columntype:
                        prevycoordinate=mox.group(7)
                        posyprepresuffixint=int(prevycoordinate[0:2],16)
                        posypresuffixint=int(prevycoordinate[2:4],16)
                        posysuffixint=int(prevycoordinate[4:6],16)
                        posyint=int(prevycoordinate[6:8],16)
                        posyremint=int(prevycoordinate[8:],16)
                        ...
                        while True:
                            ...
                            if ypresuffixint==endypresuffixint and ysuffixint==endysuffixint and yscalequotint==endyscalequotint and yscaleremint==endyscaleremint:
                                break
                            scaledh+=1
                        print(h,h*36,str(scaledh))
                        ##prevycoordinate+prevsize+64
                        #scaledh+=64
                        while scaledh>0:
                            posyremint+=1
                            if posyremint>191:
                            ...
                            if posysuffixint>231:
                                posypresuffixint+=1
                                posysuffixint=225
                            if posypresuffixint>191:
                                posyprepresuffixint+=1
                                posypresuffixint=128
                            #if posyprepresuffixint>191:
                            #    posyprepresuffixint+=1
                            #    posypresuffixint=169
                            scaledh-=1
                        print(scaledh)
                    else:
                        prevycoordinate=mox.group(7)
    ...
    if "nearlatest" in columntype:
        ...
        if "firstcolumn" in columntype or objno2<=2:
            xlochex="E5A5AA"+"E5AB81"+\\
                    "E5A5A9"+"E19E81"+\\
                    "E5A5"+"A9E19E81"
        elif ("nextcolumn" in columntype)and objno2>2:
            posxpresuffixhex=format(posxpresuffixint, \'x\')
            posxsuffixhex=format(posxsuffixint, \'x\')           
            posxhex=format(posxint, \'x\')
            posxremhex=format(posxremint, \'x\')
            xlochex="E5A5AA"+"E5AB81"+\\
                    "E5A5A9"+"E19E81"+\\
                    "E5A5"+posxpresuffixhex+\\
                    posxsuffixhex+posxhex+posxremhex
        
        if "firstline" in columntype or objno2<=2:
            ylochex="E5A5A9"+"E19E81"+\\
                    "E5A5AA"+"E5AB81"+\\
                    "E5"+"A5A9E19E81"
        elif "sameline" in columntype and objno2>2:
            ylochex="E5A5A9"+"E19E81"+\\
                    "E5A5AA"+"E5AB81"+\\
                    "E5"+prevycoordinate
        elif ("nextline" in columntype or "slidenextline" in columntype)and objno2>2:
            posyprepresuffixhex=format(posyprepresuffixint, \'x\')
            posypresuffixhex=format(posypresuffixint, \'x\')
            posysuffixhex=format(posysuffixint, \'x\')           
            posyhex=format(posyint, \'x\')
            posyremhex=format(posyremint, \'x\')
            ylochex="E5A5A9"+"E19E81"+\\
                    "E5A5AA"+"E5AB81"+\\
                    "E5"+posyprepresuffixhex+posypresuffixhex+\\
                    posysuffixhex+posyhex+posyremhex
        #+posyprepresuffixhex
    #ylochex="E5A5A9"+\\
    #"E19E81"+\\
    #"E5A5AA"+\\
        ...
        if objno2re>=0 and os.path.getsize(picdir)>0:
            ...
            if i==0:
                if "str" in str(type(column)):
                    if "slide1" in column:
                        appendnewpic(w,h,picname,newdir1,objno2re,"nearlatest;;slide1")
                    elif "slidenextline" in column:
                        appendnewpic(w,h,picname,newdir1,objno2re,"nearlatest;;slidenextline")
                else:
                    appendnewpic(w,h,picname,newdir1,objno2re,"nearlatest;;firstcolumn;;nextline")
